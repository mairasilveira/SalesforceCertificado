...
<details>
  ...
  Uma lista de opções global é uma lista de opções restrita por natureza. Somente um administrador do Salesforce pode adicionar ou modificar seus valores. Os usuários não podem adicionar valores não aprovados, mesmo por meio da API.
</details>
